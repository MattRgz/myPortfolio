        ...
        <div className='proyectContainer'>
            <div ref={firstProyect} className={`${"proyectAtLeft"} ${leftEntry?"entryFromLeft":""}` }>
                <div  style={{color:"black", textAlign:'justify',width:'30%'}}>
                    <p style={{color:"black"}}>My first project was called GestorN, It was born as a easily customizable management web for small business. It's important to say that it was my first BootCamp project, and I's mainly aimed at backend development. </p>
            ...
            <div ref={secondProyect}  className={`${"proyectAtRight"} ${rightEntry?"entryFromRight":""}` }>
                ...
                <div style={{color:"black", textAlign:'justify',width:'30%'}}>
                    <p style={{color:"black"}}>Taskify is a "To Do List" coded as a second project for my BootCamp graduation. You can create a profile and manage a list with products previusly created by the page's administrator. For this project I used design tools that can be reviewed on the documentation. </p>
                    <div className='codeLinkButtonBox'>
            ...
            <div ref={thirdProyect}  className={`${"proyectAtLeft"} ${secondLeftEntry?"entryFromLeft":""}` }>
                <div style={{color:"black", textAlign:'justify',width:'30%'}}>  
                    <p style={{color:"black"}}>Last but not least, my portfolio is my third project. I tried to give it more importance to the frontend development at the same time that I learned how to design and implement 3d stuffs. Honestly, a great achievement for me.</p>
                    <div className='codeLinkButtonBox'>
